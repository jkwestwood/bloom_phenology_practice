...
def find_bloom_maximum(chla_data, lat_idx, lon_idx, year):
    """
...
if __name__ == "__main__":
    ...
    bloom_date, bloom_chla = find_bloom_maximum(chla_data=chla_data, lat_idx=lat_idx, lon_idx=lon_idx, year=year)
