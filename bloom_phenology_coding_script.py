...
def plot_chla_time_series(chla_data, lat_idx, lon_idx, year):
    """
...
if __name__ == "__main__":
    #tests and runs the code for a specific grid cell and year
    ...
    #call function to plot the chl-a data for the specified grid cell and year

    plot_chla_time_series(chla_data=chla_data, lat_idx=lat_idx, lon_idx=lon_idx, year=year)
